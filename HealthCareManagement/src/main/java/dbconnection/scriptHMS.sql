...
CREATE TABLE StockUpdate (
    ...
    UpdateType ENUM('Purchase', 'Sale') NOT NULL,
    UpdateDate DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (ItemID) REFERENCES PharmacyInventory(ItemID)
);
...
CREATE VIEW ExpiredItemsReport AS
...
INSERT INTO StockUpdate (ItemID, QuantityChange, UpdateType)
VALUES (1, -50, 'Sale');
